...
Построенная система имеет пользовательский интерфейс в LMS и расширяет функционал Ejudge, позволяя гибко добавлять новые механизмы проверки без изменения существущих компонентов системы.
